                    ...
                    E = (function () {
                        function t(e) {
                            ...
                            if (
                                ...
                                if (
                                    ((this.settings = {}),
                                        (this.settings.cssPath = i.replace('/assetsvendor/', '/assets/vendor/')),
                                        (this.settings.themesPath = s.replace('/assetsvendor/', '/assets/vendor/')),
                                                ...
                                                return (
                                                    ...
                                                    t._getElementFromString(
                                                        '<div class="col-4 px-2">\n      <div class="form-check custom-option custom-option-icon">\n        <label class="form-check-label custom-option-content p-0" for="'
                                                            ...
                                                            .concat(assetsPath.replace('assets', 'assets/'), "img/customizer/")
                                                            .concat(n)
